            ...
            switch (t.label) {
              ...
              case 'H':
                (n = (function (e) {
                  ...
                  false === n ? (r.value = o()) : t.onUpdateValue(n);
                break;
              case 'S':
              case 'L':
              case 'V':
    ...
    setup(r, { slots: c }) {
      ...
      function se(e = true) {
        ...
        if (t) {
          ...
          const { value: l } = V,
            { value: i } = N;
          e && (l.splice(i + 1, l.length, t), (N.value = i + 1));
          n();
          o();
        }
      }
      function ue() {
        const { value: e } = N;
        e - 1 < 0 ||
          (le(V.value[e - 1], 'input'), se(false), (N.value = e - 1));
      }
      function ce() {
        const { value: e } = N;
        e < 0 ||
      ...
      return {
        ...
        handleClickOutside(t) {
          ...
          (null === (r = d.value) || void 0 === r
            ? void 0
            : r.contains(e.getPreciseEventTarget(t))) || B(false);
        },
      ...
      const c = e.ref(null),
        d = e.computed$1(() => ({
          showName: [
            {
              required: true,
              message: i('Please enter the application name'),
            },
          ],
          translateServe: [
            {
              required: true,
              message: i('Please select a translation server'),
            },
          ],
          sendTo: [
            {
          ...
          fontSize: [
            {
              required: true,
              message: i('Please set the font size'),
            },
          ],
          fontColor: [
            {
              required: true,
              message: i('Please set the font color'),
            },
          ],
        })),
